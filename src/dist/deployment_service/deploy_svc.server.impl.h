...
namespace dsn 
{
    namespace dist
    {
        ...
        public:
            ...
            void on_deploy_cli(void *context, int argc, const char **argv, dsn_cli_reply *reply);

            void on_undeploy_cli(void *context, int argc, const char **argv, dsn_cli_reply *reply);

            void on_get_service_list_cli(void *context, int argc, const char **argv, dsn_cli_reply *reply);

            void on_get_service_info_cli(void *context, int argc, const char **argv, dsn_cli_reply *reply);

            void on_get_cluster_list_cli(void *context, int argc, const char **argv, dsn_cli_reply *reply);
        ...
        private:
            ...
            void on_get_service_list_internal(const std::string& package_id, deploy_info_list& dlist);

            void on_get_service_info_internal(const std::string& service_url, deploy_info& di);

            void on_get_cluster_list_internal(const std::string& format, cluster_list& clist);
